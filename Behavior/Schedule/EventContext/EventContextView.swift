//
// This source file is part of the Stanford HPDS Application based on the Stanford Spezi Template Application
//
...
struct EventContextView_Previews: PreviewProvider {
    ...
    private static let task = BehaviorScheduler().tasks.first!
